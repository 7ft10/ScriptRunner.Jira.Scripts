// ********************************
// This groovy script copies version changes from the master to the child projects
//
...
// Dates need to be formatted for input (even if they came from Jira in the first place!)
def formatDate(d) {
...
if (webhookEvent == "jira:version_updated") {
    // if updated the version doesn't include all the information!
...
// find all child projects, aka projects in the target categories
